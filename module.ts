...
namespace Polymesh {
    ...
    export function renderAll(plms: polymesh[], output: Image, linecolor?: number) {
        ...
        switch (sort) {
            ...
            case 0x1:          introSort(sorted, (a, b) => b.depth - a.depth, true); break
            case 0x2: default: introSort(sorted, (a, b) => b.depth - a.depth); break
        }
    ...
    export function render(plm: polymesh, output: Image, linecolor?: number) {
        ...
        switch (sort) {
            ...
            case 0x1:          introSort(tris, (a, b) => avgZ(rotated, b.indices) - avgZ(rotated, a.indices), true); break
            case 0x2: default: introSort(tris, (a, b) => avgZ(rotated, b.indices) - avgZ(rotated, a.indices)); break
        }
